...
std::vector<int> convertRcppToStd(const Rcpp::IntegerVector& rcppVec) {
    std::vector<int> stdVec(rcppVec.begin(), rcppVec.end());
    return stdVec;
    }
/**
...
Rcpp::List tree_search_rcpp(const Rcpp::NumericMatrix& X,
                            ...
                            int split_step,
                            int min_node_size,
                            Rcpp::IntegerVector& max_treatment_size) {
  ...
  std::vector<int> max_treatment_size_vector;
  max_treatment_size_vector = convertRcppToStd(max_treatment_size);
  Rcpp::Rcout << "The values of max_treatment_size_vector: ";
  for (int value : max_treatment_size_vector) {
    Rcpp::Rcout << value << " ";
    }
  Rcpp::Rcout << "\n";
  std::unique_ptr<Node> root = tree_search(depth, split_step, min_node_size, data, max_treatment_size_vector);
